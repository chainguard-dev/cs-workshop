...
pe "git diff --no-index -U1000 ../layers/Dockerfile.2 Dockerfile.1"
...
pe "docker run --rm --entrypoint sh -u root mstage:2b -c 'apk add --no-cache posix-libc-utils && ldd /usr/bin/jq'"
